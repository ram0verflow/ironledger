    ...
    <div className="flex flex-col min-h-screen  text-foreground font-mono">
      <main className="flex-grow container mx-auto px-4 py-8 sm:py-16">
        ...
        <div className="grid sm:grid-cols-2 gap-6 sm:gap-8 md:gap-12">
          <div className="border border-foreground/10 p-4 sm:p-6 hover:border-primary transition-all duration-300 bg-background/60 backdrop-blur-sm rounded-lg">
            ...
            <Link
              href="/explorer"
              className="inline-flex items-center justify-center space-x-2 w-full border border-primary text-primary hover:bg-primary hover:text-background transition-colors duration-300 py-2 sm:py-3 text-sm sm:text-base rounded-md"
            >
